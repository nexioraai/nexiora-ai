...
const CONTENT = {
  fr: {
    ...
    intro:
      "Les présentes conditions d'utilisation (les « Conditions ») régissent votre utilisation de Woorri, un service exploité par Dougma IA Technologies (Montréal, Québec, Canada), ci-après « Woorri », « nous » ou « notre ». En créant un compte ou en utilisant Woorri, vous acceptez ces Conditions. Si vous ne les acceptez pas, vous ne pouvez pas utiliser le service.",
    sections: [
      {
        h: '1. Description du service',
        p: [
          "Woorri est un outil logiciel qui permet aux utilisateurs (les « marchands ») de générer et d'exploiter automatiquement des boutiques en ligne. Woorri fournit la technologie : génération de site, hébergement, connexion à des fournisseurs et traitement technique des paiements. Woorri n'est pas un vendeur, ne possède pas les produits offerts par les marchands et n'est pas partie aux contrats de vente conclus entre un marchand et ses clients.",
        ],
      },
      {
        h: '2. Comptes',
        p: [
          "Pour utiliser Woorri, vous devez créer un compte et fournir des renseignements exacts. Vous êtes responsable de la confidentialité de vos identifiants et de toute activité effectuée sous votre compte. Vous devez avoir l'âge de la majorité dans votre province ou pays et la capacité juridique de conclure un contrat.",
        ],
      },
      {
        ...
        p: [
          ...
          "Woorri fournit l'outil, mais la boutique et les ventes sont les vôtres. Vous nous dégagez de toute responsabilité liée à vos produits, à vos ventes et à vos relations avec vos clients.",
        ],
      },
      {
        h: '4. Rôle de Woorri dans les paiements',
        p: [
          "Pour les boutiques en mode dropshipping automatisé, les paiements des clients sont traités par notre prestataire Stripe. Woorri facilite techniquement la transaction et prélève une commission (actuellement 6 %) sur chaque vente, ainsi que les frais liés à l'exécution de la commande auprès du fournisseur. Woorri n'agit qu'à titre de facilitateur technique du paiement.",
          "Woorri ne garantit pas les produits fournis par les fournisseurs tiers (notamment leur qualité, leur disponibilité ou leurs délais de livraison). Les fournisseurs disponibles sur la plateforme sont sélectionnés par Woorri, mais le choix des produits et de leurs prix appartient au marchand. Tout litige portant sur un produit relève de la relation entre le marchand et son client.",
        ],
      },
      {
        h: '5. Abonnement et facturation',
        p: [
          "L'accès à certaines fonctionnalités de Woorri est offert par abonnement. Les frais, la fréquence de facturation et les modalités sont indiqués au moment de la souscription. Sauf indication contraire, les abonnements se renouvellent automatiquement. Vous pouvez annuler votre abonnement à tout moment; l'annulation prend effet à la fin de la période de facturation en cours. Les montants déjà payés ne sont généralement pas remboursables, sauf disposition légale contraire.",
        ],
      },
      {
        h: '6. Utilisation acceptable',
        p: [
          "Vous acceptez de ne pas utiliser Woorri pour :",
      ...
      },
      {
        ...
        p: [
          "Woorri et sa technologie (code, design, marque « Woorri ») demeurent la propriété de Dougma IA Technologies. Le contenu que vous créez pour votre boutique (textes, images, produits) demeure le vôtre. En utilisant Woorri, vous nous accordez une licence limitée nécessaire à l'hébergement et à l'affichage de votre boutique.",
        ],
      },
      {
        h: '8. Limitation de responsabilité',
        p: [
          "Dans les limites permises par la loi, Woorri est fourni « tel quel » et « selon disponibilité ». Nous ne garantissons pas que le service sera exempt d'erreurs ou d'interruptions. Woorri ne peut être tenu responsable des pertes de profits, des pertes de données, ni des dommages indirects découlant de l'utilisation du service, de la relation avec vos clients ou du comportement de fournisseurs tiers. Notre responsabilité totale, le cas échéant, ne dépassera pas les montants que vous nous avez payés au cours des douze derniers mois.",
        ],
      },
      {
        h: '9. Résiliation',
      ...
      },
      {
        ...
        p: [
          "Nous pouvons modifier ces Conditions. Toute modification importante sera signalée sur cette page avec une nouvelle date de mise à jour. En continuant d'utiliser Woorri après une modification, vous acceptez les Conditions révisées.",
        ],
      },
      {
  ...
  en: {
    ...
    intro:
      "These Terms of Service (the “Terms”) govern your use of Woorri, a service operated by Dougma IA Technologies (Montreal, Quebec, Canada), referred to below as “Woorri,” “we,” or “our.” By creating an account or using Woorri, you agree to these Terms. If you do not agree, you may not use the service.",
    sections: [
      {
        h: '1. Description of the service',
        p: [
          "Woorri is a software tool that allows users (“merchants”) to automatically generate and operate online stores. Woorri provides the technology: site generation, hosting, supplier connections, and technical payment processing. Woorri is not a seller, does not own the products offered by merchants, and is not a party to the sales contracts between a merchant and their customers.",
        ],
      },
      {
        h: '2. Accounts',
        p: [
          "To use Woorri, you must create an account and provide accurate information. You are responsible for keeping your credentials confidential and for all activity under your account. You must be of the age of majority in your province or country and legally able to enter into a contract.",
        ],
      },
      {
        ...
        p: [
          ...
          "Woorri provides the tool, but the store and the sales are yours. You release us from any liability related to your products, your sales, and your relationships with your customers.",
        ],
      },
      {
        h: "4. Woorri's role in payments",
        p: [
          "For automated dropshipping stores, customer payments are processed by our provider Stripe. Woorri technically facilitates the transaction and charges a commission (currently 6%) on each sale, along with the costs related to fulfilling the order with the supplier. Woorri acts only as a technical payment facilitator.",
          "Woorri does not guarantee the products supplied by third-party suppliers (including their quality, availability, or delivery times). The suppliers available on the platform are selected by Woorri, but the choice of products and their prices belongs to the merchant. Any dispute regarding a product is a matter between the merchant and their customer.",
        ],
      },
      {
        h: '5. Subscription and billing',
        p: [
          "Access to certain Woorri features is offered by subscription. Fees, billing frequency, and terms are shown at the time of subscription. Unless otherwise stated, subscriptions renew automatically. You may cancel your subscription at any time; cancellation takes effect at the end of the current billing period. Amounts already paid are generally non-refundable, except where required by law.",
        ],
      },
      {
        h: '6. Acceptable use',
        p: [
          "You agree not to use Woorri to:",
      ...
      },
      {
        ...
        p: [
          "Woorri and its technology (code, design, the “Woorri” brand) remain the property of Dougma IA Technologies. The content you create for your store (text, images, products) remains yours. By using Woorri, you grant us a limited license necessary to host and display your store.",
        ],
      },
      {
        h: '8. Limitation of liability',
        p: [
          "To the extent permitted by law, Woorri is provided “as is” and “as available.” We do not warrant that the service will be error-free or uninterrupted. Woorri shall not be liable for loss of profits, loss of data, or indirect damages arising from your use of the service, your relationship with your customers, or the conduct of third-party suppliers. Our total liability, if any, will not exceed the amounts you have paid us in the previous twelve months.",
        ],
      },
      {
        h: '9. Termination',
      ...
      },
      {
        ...
        p: [
          "We may modify these Terms. Any significant change will be posted on this page with a new update date. By continuing to use Woorri after a change, you accept the revised Terms.",
        ],
      },
      {
        h: '11. Governing law',
