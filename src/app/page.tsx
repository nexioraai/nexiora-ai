...
export default function Home() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setError(err.message || 'Échec de génération');
    } finally {
      setLoading(false);
    }
  };
  ...
  const updateSocial = useCallback(
    (
      platform: keyof AIResponse['socialLinks'],
      value: string
    ) => {
      if (!editedResult) return;
    ...
    <main className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
      ...
      <section className="text-center px-6 pt-24 pb-16">
        ...
        <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-8">
          Nexiora automatically creates websites, dashboards, and apps for
          entrepreneurs.
        </p>
            ...
            <div className="mt-8 bg-black/30 border border-white/10 rounded-2xl p-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {editedResult.pages.map((page, i) => (
                    <Link
                      ...
                      href={
                        pageRoutes[
                          page as keyof typeof pageRoutes
                        ] || '/'
                      }
                ...
                <div className="grid gap-3">
                  {editedResult.services.map((service, i) => (
                    <input
                      ...
                      value={service}
                      onChange={(e) =>
                        updateService(i, e.target.value)
                      }
              ...
              <div className="mb-6">
                ...
                <div className="grid gap-3">
                  <input
                    value={
                      editedResult.socialLinks?.instagram || ''
                    }
                    onChange={(e) =>
                      updateSocial(
                        'instagram',
                  ...
                  <input
                    value={
                      editedResult.socialLinks?.whatsapp || ''
                    }
                    onChange={(e) =>
                      updateSocial(
                        'whatsapp',
                  ...
                  <input
                    value={
                      editedResult.socialLinks?.facebook || ''
                    }
                    onChange={(e) =>
                      updateSocial(
                        'facebook',
