...
export default function MonochromeTheme({ site }: { site: Site }) {
  ...
  return (
    <div className="min-h-screen bg-white text-black antialiased">
      ...
      {/* ABOUT */}
      {site.about && (
        <section id="about" className="reveal py-28 md:py-36 border-t border-black">
      ...
      {/* SERVICES */}
      {services.length > 0 && (
        <section id="services" className="reveal py-28 md:py-36 bg-black text-white">
      ...
      {/* SHOP */}
      {products.length > 0 && (
        <section id="shop" className="reveal py-28 md:py-36 border-t border-black">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-20">
      ...
      {/* GALLERY */}
      {gallery.length > 0 && (
        <section id="gallery" className="reveal py-28 md:py-36 border-t border-black">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-20">
      ...
      {testimonials.length > 0 && (
        <section id="testimonials" className="reveal py-28 md:py-36 bg-black text-white">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-20">
      ...
      {site.faq && site.faq.length > 0 && (
        <section id="faq" className="reveal py-28 md:py-36 border-t border-black">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-16">
              <div className="text-xs font-medium tracking-[0.2em] uppercase opacity-60">
                {({ fr: 'FAQ', en: 'FAQ', es: 'FAQ', ar: 'الأسئلة' } as Record<string, string>)[site.lang || 'en'] || 'FAQ'}
              </div>
              <h2 className="text-4xl md:text-5xl font-bold leading-tight uppercase tracking-tighter">
                {({ fr: 'Questions fréquentes', en: 'Frequently asked questions', es: 'Preguntas frecuentes', ar: 'الأسئلة الشائعة' } as Record<string, string>)[site.lang || 'en'] || 'Frequently asked questions'}
              </h2>
            </div>
            <div className="border-t border-black">
              {site.faq.map((item, i) => (
                <details key={i} className="group border-b border-black py-6">
                  <summary className="cursor-pointer list-none flex justify-between items-center text-lg md:text-xl font-bold uppercase tracking-tight">
                    {item.question}
                    <span className="ml-4 transition-transform group-open:rotate-45">+</span>
                  </summary>
                  <p className="mt-4 text-black/60 leading-relaxed">{item.answer}</p>
                </details>
              ))}
            </div>
          </div>
      ...
      {/* CONTACT */}
      <section id="contact" className="reveal py-28 md:py-36 border-t border-black">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-20">
