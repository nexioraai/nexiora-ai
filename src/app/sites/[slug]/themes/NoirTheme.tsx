                ...
                <div className="relative ed-rise">
                  ...
                  {site.hero_image ? (
                    <div className="relative aspect-[4/5] rounded-[1.75rem] overflow-hidden" style={{ border: `1px solid ${LINE}` }}>
                      <img src={site.hero_image} alt={site.name} className="w-full h-full object-cover hero-float" />
          ...
          <section id="contact" className="reveal py-28 md:py-36" style={{ borderTop: `1px solid ${LINE}` }}>
            <div className="max-w-3xl mx-auto px-6 md:px-10 text-center">
              ...
              <div className="grid sm:grid-cols-3 gap-4 mt-10 text-left">
                {contact.phone && (
                  <a href={`tel:${contact.phone}`} className="flex items-center gap-4 p-5 rounded-2xl border transition-all" style={{ borderColor: LINE, backgroundColor: 'rgba(245,243,238,0.03)' }}>
                ...
                {contact.email && (
                  <a href={`mailto:${contact.email}`} className="flex items-center gap-4 p-5 rounded-2xl border transition-all" style={{ borderColor: LINE, backgroundColor: 'rgba(245,243,238,0.03)' }}>
                    <div className="flex items-center justify-center w-10 h-10 rounded-xl shrink-0" style={{ backgroundColor: `${gold}20` }}>
