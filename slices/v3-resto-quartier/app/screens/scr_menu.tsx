  ...
  return (
    <ScreenShell testID="scr_menu" title={screenData.title}>
      <View style={{ flex: 1, paddingBottom: insets.bottom }}>
        ...
        <AirList screen={screenData} blockId="blk_menu_liste_plats" />
        <AirEmptyState screen={screenData} blockId="blk_menu_etat_vide" />
        <AirButton screen={screenData} blockId="blk_menu_btn_plat" />
        <AirButton screen={screenData} blockId="blk_menu_btn_panier" />
        <AirButton screen={screenData} blockId="blk_menu_btn_commandes" />
        <AirButton screen={screenData} blockId="blk_menu_btn_compte" />
      </View>
    </ScreenShell>
  );
}
