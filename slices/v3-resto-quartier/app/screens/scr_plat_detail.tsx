...
import { AirButton, AirDetailHeader, AirForm, AirHeader, AirScreenLifecycle } from "../lib/runtime/air-runtime";
  ...
  return (
    <ScreenShell testID="scr_plat_detail" title={screenData.title}>
      ...
      >
        ...
        <AirHeader screen={screenData} blockId="blk_plat_delai_header" />
        <AirForm screen={screenData} blockId="blk_plat_form_ajout" />
        <AirButton screen={screenData} blockId="blk_plat_btn_ajouter" />
        <AirButton screen={screenData} blockId="blk_plat_btn_panier" />
        <AirButton screen={screenData} blockId="blk_plat_btn_retour" />
      </ScrollView>
    </ScreenShell>
  );
}
