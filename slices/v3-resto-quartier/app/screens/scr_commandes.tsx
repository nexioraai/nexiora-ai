  ...
  return (
    <ScreenShell testID="scr_commandes" title={screenData.title}>
      <View style={{ flex: 1, paddingBottom: insets.bottom }}>
        ...
        <AirEmptyState screen={screenData} blockId="blk_commandes_etat_vide" />
        <AirButton screen={screenData} blockId="blk_commandes_btn_suivi" />
        <AirButton screen={screenData} blockId="blk_commandes_btn_retour" />
      </View>
    </ScreenShell>
  );
}
