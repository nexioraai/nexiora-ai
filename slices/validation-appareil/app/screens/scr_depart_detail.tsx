...
import { screenData } from "./scr_depart_detail.data";

export default function ScrDepartDetailScreen({ route }: AirScreenProps) {
  ...
  return (
    <ScreenShell testID="scr_depart_detail" title={screenData.title}>
      ...
      <PrimaryNav destinations={primaryNav} currentScreenId="scr_depart_detail" />
    </ScreenShell>
  );
}
