...
import { AirEmptyState, AirHeader, AirList, AirScreenLifecycle } from "../lib/runtime/air-runtime";
  ...
  return (
    <ScreenShell testID="scr_accueil" title={screenData.title}>
      ...
      <View style={{ flex: 1, paddingBottom: insets.bottom }}>
        ...
        <AirList screen={screenData} blockId="blk_accueil_liste_departs" itemId={route?.params?.itemId} />
        <AirEmptyState screen={screenData} blockId="blk_accueil_vide" />
      </View>
