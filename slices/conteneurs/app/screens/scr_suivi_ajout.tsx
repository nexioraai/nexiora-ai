...
import { screenData } from "./scr_suivi_ajout.data";

export default function ScrSuiviAjoutScreen() {
  const insets = useSafeAreaInsets();
  return (
    <ScreenShell testID="scr_suivi_ajout" title={screenData.title}>
      <ScrollView
        contentContainerStyle={{ paddingBottom: insets.bottom }}
        automaticallyAdjustKeyboardInsets
        keyboardShouldPersistTaps="handled"
      >
        <AirHeader screen={screenData} blockId="blk_ajout_header" />
        <AirForm screen={screenData} blockId="blk_ajout_formulaire" />
      </ScrollView>
    </ScreenShell>
  );
}
