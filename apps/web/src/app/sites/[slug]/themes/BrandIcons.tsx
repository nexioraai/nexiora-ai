// src/app/sites/[slug]/themes/BrandIcons.tsx
// Icônes de marques sociales en SVG inline.
// lucide-react a retiré les brand icons — on les définit nous-mêmes.
...
export function TikTok({ className, size = 20 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
