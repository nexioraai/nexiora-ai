...
const CONTENT = {
  fr: {
    home: 'Accueil',
    heroKicker: 'À propos de Deribfy',
    ...
    missionP:
      "Rendre accessibles à toutes les entreprises — des indépendants aux équipes en croissance — des capacités numériques qui étaient jusqu'ici réservées aux grandes organisations disposant d'équipes techniques dédiées. Deribfy supprime la complexité : décrivez votre objectif, la plateforme s'occupe du reste.",
    ...
    values: [
      ...
      { h: "Intelligence au service de l'humain", p: "L'IA de Deribfy assiste et recommande ; les décisions restent entre vos mains." },
    ...
    capsLead: "Deribfy regroupe des outils complémentaires pensés pour fonctionner ensemble :",
    caps: [
      ...
      { h: 'Intégrations', p: 'Connectez vos outils et services existants à votre espace Deribfy.' },
    ],
    aiH: "L'approche IA de Deribfy",
    aiP:
      "L'intelligence artificielle est au cœur de Deribfy, mais elle reste un moyen, pas une fin. Elle accélère la création, éclaire vos décisions et automatise ce qui peut l'être — toujours à partir de vos données réelles, et toujours sous votre contrôle. Deribfy ne remplace pas votre jugement : il vous donne les moyens de mieux décider, plus vite.",
    companyH: "L'entreprise",
    companyP:
      "Deribfy est un produit développé et exploité par Dougma IA Technologies, une entreprise basée à Montréal, au Québec (Canada).",
  ...
  en: {
    home: 'Home',
    heroKicker: 'About Deribfy',
    heroTitle: 'The unified platform to create, manage and grow your digital presence.',
    heroLead:
      'Deribfy is an AI-powered SaaS platform that brings together, in a single interface, the tools a business needs to launch and grow online: website creation, e-commerce, marketing, automation, data analytics and conversational AI.',
    missionH: 'Our mission',
    missionP:
      'To make digital capabilities that were once reserved for large organizations with dedicated technical teams accessible to every business — from solo founders to growing teams. Deribfy removes the complexity: describe your goal, and the platform handles the rest.',
    visionH: 'Our vision',
    visionP:
    ...
    values: [
      ...
      { h: 'Intelligence in service of people', p: 'Deribfy’s AI assists and recommends; decisions stay in your hands.' },
      { h: 'Reliability', p: 'A platform you can count on every day to run your business.' },
    ],
    capsH: 'One platform, many capabilities',
    capsLead: 'Deribfy combines complementary tools designed to work together:',
    caps: [
      ...
      { h: 'Integrations', p: 'Connect your existing tools and services to your Deribfy workspace.' },
    ],
    aiH: 'Deribfy’s approach to AI',
    aiP:
      'Artificial intelligence is at the heart of Deribfy, but it remains a means, not an end. It speeds up creation, informs your decisions and automates what can be automated — always from your real data, and always under your control. Deribfy doesn’t replace your judgment: it helps you make better decisions, faster.',
    companyH: 'The company',
    companyP:
      'Deribfy is a product built and operated by Dougma IA Technologies, a company based in Montreal, Quebec (Canada).',
