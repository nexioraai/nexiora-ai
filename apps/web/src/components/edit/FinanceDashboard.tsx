  ...
  return (
    <div className="glass glass-hover rounded-3xl p-6 md:p-8 mt-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={() => {
            ...
            const lines = [
              'Date,Revenus,Cout Fournisseur,Commission Deribfy,Profit Net,Commandes',
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card label="Commission Deribfy" value={`${fmt(s.total_commission)} ${s.currency}`} color="#FA5D1E" />
