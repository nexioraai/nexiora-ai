...
export default function ScrPanierScreen() {
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center", gap: 12 }}>
      <Text testID="scr_panier">{navData.routes.find((r) => r.screenId === "scr_panier")!.title}</Text>
      ...
      <Pressable testID="nav_to_scr_plat_detail" onPress={() => navigation.navigate("scr_plat_detail" as never)}>
