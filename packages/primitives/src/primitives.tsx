...
export function ScreenShell({ title, children, testID, accessibilityLabel }: ScreenShellProps) {
  ...
  return (
    <View style={s.shell} testID={testID} accessibilityLabel={accessibilityLabel}>
      <Text style={s.shellTitle} accessibilityRole="header">
        {title}
      </Text>
      {children}
    </View>
